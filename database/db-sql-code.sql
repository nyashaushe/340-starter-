...
ALTER TYPE public.account_type
    OWNER TO current_user; -- Use the current role running the script
...
----------------------------Step 6 ADD DATA TO THE TABLES-----------------------------------------

--Step 1 data for table 'classification'
...
-- Step 2 Data for table `inventory`
